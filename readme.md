...
- Uses semi-supervised pipeline, utilising image embeddings from resnet18 to output high quality image embeddings to feed a custom logistic regression based classifier built using Pytorch
